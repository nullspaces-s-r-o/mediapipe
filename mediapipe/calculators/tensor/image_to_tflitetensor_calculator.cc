...
//   }
// }
class ImageToTfLiteTensorCalculator : public Node {
 public:
  ...
  static constexpr Input<mediapipe::NormalizedRect>::Optional kInNormRect{
      "NORM_RECT"};
  static constexpr Output<std::vector<TfLiteTensor>> kOutTensors{"TENSORS"};
...
MEDIAPIPE_REGISTER_NODE(ImageToTfLiteTensorCalculator);
