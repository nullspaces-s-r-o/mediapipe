...
#ifndef MEDIAPIPE_CALCULATORS_TENSOR_IMAGE_TO_IMAGE_CONVERTER_H_
#define MEDIAPIPE_CALCULATORS_TENSOR_IMAGE_TO_IMAGE_CONVERTER_H_
...
class ImageToImageConverter {
 public:
  virtual ~ImageToImageConverter() = default;
  ...
  virtual absl::Status Convert(const mediapipe::Image& input,
                               ...
                               mediapipe::ImageFrame& output_image) = 0;
};

}  // namespace mediapipe

#endif  // MEDIAPIPE_CALCULATORS_TENSOR_IMAGE_TO_IMAGE_CONVERTER_H_
