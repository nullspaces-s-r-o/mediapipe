...
static auto CreateTfLiteTensor(TfLiteType type,
  ...
  tflite_tensor->data.raw = static_cast<char*>(malloc(tflite_tensor->bytes));
  memset(tflite_tensor->data.raw, 0, tflite_tensor->bytes);
