...
//   options {
//     [DetectionsToTrainDataCalculatorOptions.ext] {
//       produce_empty_packet : false
//     }
//   }
// }
class DetectionsToTrainDataCalculator : public CalculatorBase {
 public:
  DetectionsToTrainDataCalculator() {}
  ~DetectionsToTrainDataCalculator() override {}
  DetectionsToTrainDataCalculator(const DetectionsToTrainDataCalculator&) =
      delete;
  DetectionsToTrainDataCalculator& operator=(
      const DetectionsToTrainDataCalculator&) = delete;
...
REGISTER_CALCULATOR(DetectionsToTrainDataCalculator);

absl::Status DetectionsToTrainDataCalculator::GetContract(
    CalculatorContract* cc) {
  RET_CHECK(cc->Inputs().HasTag(kDetectionListTag) ||
            cc->Inputs().HasTag(kDetectionsTag) ||
            cc->Inputs().HasTag(kDetectionTag) ||
            cc->Inputs().HasTag(kImageFrameTag))
...
absl::Status DetectionsToTrainDataCalculator::Open(CalculatorContext* cc) {
...
absl::Status DetectionsToTrainDataCalculator::Process(CalculatorContext* cc) {
  ...
  // bool has_detections = cc->Inputs().HasTag(kDetectionsTag);
  // bool is_empty = cc->Inputs().Tag(kDetectionsTag).IsEmpty();
  ...
  // DetectionsToTrainDataCalculatorOptions.
...
void DetectionsToTrainDataCalculator::SetRenderAnnotationColorThickness(
    const DetectionsToRenderDataCalculatorOptions& options,
    RenderAnnotation* render_annotation) {
...
void DetectionsToTrainDataCalculator::SetTextCoordinate(
...
void DetectionsToTrainDataCalculator::SetRectCoordinate(
...
void DetectionsToTrainDataCalculator::AddLabels(
    const Detection& detection,
    const DetectionsToRenderDataCalculatorOptions& options,
    float text_line_height, RenderData* render_data) {
...
void DetectionsToTrainDataCalculator::AddFeatureTag(
    const Detection& detection,
    const DetectionsToRenderDataCalculatorOptions& options,
    float text_line_height, RenderData* render_data) {
...
void DetectionsToTrainDataCalculator::AddLocationData(
    const Detection& detection,
    const DetectionsToRenderDataCalculatorOptions& options,
    RenderData* render_data) {
...
void DetectionsToTrainDataCalculator::AddDetectionToRenderData(
    const Detection& detection,
    const DetectionsToRenderDataCalculatorOptions& options,
    RenderData* render_data) {
