...
absl::Status RunMPPGraph() {
  ...
  if (load_video) {
    ...
    ABSL_LOG(INFO) << "load the video " << absl::GetFlag(FLAGS_input_video_path);
...
//    camera_frame_raw = cv::imread("hands.jpg", cv::IMREAD_COLOR);
...
//     cv::imwrite("res.bmp", output_frame_mat);
//     grab_frames = false;
  }
